    ...
    context("createMemoのテスト") {
        ...
        context("正常系") {
            test("メモの更新が成功した場合、メモ詳細データが返却されること") {
                ...
                coEvery { mockTokenManager.getAccessToken() } returns "Access Token"
                coEvery { mockApi.createMemo(any(), any()) } returns Response.success(response)
        ...
        context("異常系") {
            ...
            test("APIが成功を返してもレスポンスボディがnullの場合、既定のエラーメッセージが返却されること") {
                // Arrange
                coEvery { mockTokenManager.getAccessToken() } returns "Access Token"
                coEvery { mockApi.createMemo(any(), any()) } returns Response.success(null)
            ...
            context("サーバーからエラーが返却") {
                ...
                """.trimIndent()
                    ...
                    coEvery { mockApi.createMemo(any(), any()) } returns Response.error(
                        500,
                        responseBody
                    )
